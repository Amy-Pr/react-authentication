...
const UserSignIn = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await api ("/users", "POST", user); //we're using our api function from utils which has a fancy fetch method. The parameters are the url path, the method, and the body. 'POST' means sending data to the server
